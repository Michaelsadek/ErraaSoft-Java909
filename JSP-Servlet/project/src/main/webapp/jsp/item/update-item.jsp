...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; outline: none; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
    ...
    .section-title { font-size: 1.5rem; color: #9b59b6; margin: 30px 0 20px; padding-bottom: 10px; 
...
<div class="container">
  ...
  <form action="<%=request.getContextPath()%>/ItemController" method="POST" onsubmit="return validateForm()">
    ...
    <div class="form-row">
      <div class="input-data">
        <input type="number" name="totalNumber" id="totalNumber" value="${item.totalNumber}" required 
               min="0" step="1">
    ...
    <div class="form-row">
      <div class="input-data" style="height: 100px;">
        <textarea name="description" id="description">${item.details.description}</textarea>
    ...
    <div class="form-row">
      <div class="input-data">
        <input type="date" name="issueDate" id="issueDate" 
               value="${item.details.issueDate}">
        <label>Issue Date</label>
      </div>
      <div class="input-data">
        <input type="date" name="expiryDate" id="expiryDate" 
               value="${item.details.expiryDate}">
